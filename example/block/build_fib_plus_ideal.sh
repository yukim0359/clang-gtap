...
SRC="${SCRIPT_DIR}/fib_plus_ideal.cu"
OUT_DIR="${SCRIPT_DIR}/out"
OUT_EXEC="${OUT_DIR}/fib_plus_ideal"
...
echo "============================================"
echo "  GTaP Fibonacci Plus Heavy Ideal Test Script"
echo "============================================"
...
"${CLANG_BIN}" -O3 -x cuda \
  ...
  "${SRC}" -o "${OUT_EXEC}" 2>&1 | tee "${OUT_DIR}/fib_ideal_compile.log"
...
echo "  - Compile log: ${OUT_DIR}/fib_ideal_compile.log"
