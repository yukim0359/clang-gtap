...
SRC="${SCRIPT_DIR}/spmv_ideal.cu"
OUT_DIR="${SCRIPT_DIR}/out"
OUT_EXEC="${OUT_DIR}/spmv_ideal"
...
echo "============================================"
echo "  GTaP SpMV Ideal Test Script"
echo "============================================"
...
"${CLANG_BIN}" -O3 -x cuda \
  ...
  "${SRC}" -o "${OUT_EXEC}" 2>&1 | tee "${OUT_DIR}/spmv_ideal_compile.log"
...
"${OUT_EXEC}" /work/gc64/c64099/gpu-task-runtime/block/util/spm_data_skew.bin
EXIT_CODE=$?
echo "============================================"
echo ""
...
echo "  - Compile log: ${OUT_DIR}/spmv_ideal_compile.log"
