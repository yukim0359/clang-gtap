...
SRC="${SCRIPT_DIR}/nq_ideal.cu"
OUT_DIR="${SCRIPT_DIR}/out"
OUT_EXEC="${OUT_DIR}/nq_ideal"
...
echo "============================================"
echo "  GTaP N-Queens Ideal Test Script"
echo "============================================"
...
"${CLANG_BIN}" -O3 -x cuda \
  ...
  "${SRC}" -o "${OUT_EXEC}" 2>&1 | tee "${OUT_DIR}/nq_ideal_compile.log"
...
echo "  - Compile log: ${OUT_DIR}/nq_ideal_compile.log"
